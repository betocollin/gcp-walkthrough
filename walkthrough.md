...
<walkthrough-metadata>
  <meta name="title" content="Deploying {SolutionName}" />
  <meta name="description" content="A step by step guide on configuring cloud and deploying the dashboard." />
</walkthrough-metadata>

## Introduction

In this walkthrough, you'll generate OAuth credentials in preparation for the deployment of {SolutionName}.
...
Enable the following APIs so that we are able use the respective Cloud resources.

<walkthrough-enable-apis apis="bigquery.googleapis.com,googleads.googleapis.com,youtube.googleapis.com,cloudfunctions.googleapis.com,cloudscheduler.googleapis.com,workflows.googleapis.com,run.googleapis.com,cloudbuild.googleapis.com ">
...
Congratulations. You've set up {SolutionName}!
